    ...
    <tbody>
        <?php while ($ContendCat = $result->fetch_object()) { ?>
            <tr>
                ...
                <td><button onclick="mostrarActualizacion(this)" data-nombrecat="<?php echo $ContendCat->nombre; ?>"
                        data-fechacat="<?php echo $ContendCat->Cat_Creacion; ?>"
                        data-clavecat="<?php echo $ContendCat->id; ?>">UPDATE</button></td>
                <td><button onclick="return confirm('Confirma eliminacion')"><a
                            href=" index.php?accion=delCategoria&clave3=<?php echo $ContendCat->id; ?>">DELETE</a></button>
                </td>
            </tr>
        <?php } ?>
    </tbody>
...
<div id="fmrcategoria" title="NEW CATEGORIE">
    <form action="" id="razihell" method="get">
        ...
        <div class="form-field">
            <label for="BornFech">Fecha Creacion</label>
