...
// if (isset($id)) {
    if ($id > 0) {
        $sql = "SELECT p.especificaciones, p.marca, p.tipo ,p.modelos, p.precio, p.id_imagen, c.nombre AS nombre_cat, p.id AS id_prod, i.ruta_img, i.id_imag FROM productos AS p
